...
public class LoginController extends UserBaseController {
	...
	public static final String ADMIN_IN_COOKIE_KEY = "com.meteor.mc.cookie";

	public static final String ADMIN_IN_PASSPORT_KEY = "com.meteor.mc.login.passport";

	/** Cookie 值分割符 */
	public static final String COOKIE_SPLIT_FLAG = "`==`";

	/** 水印字符码 */
	public static final String SIGN = "tIVaeY1A5XyBPqCwp4qB";

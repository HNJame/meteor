...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>创建导出表数据至cassandra(用于join)</title>
		<!-- header js css -->
				...
				<div id="content">
					...
					<div id="breadcrumb_div" name="breadcrumb_div">
						<ul class="breadcrumb">
							...
							<li>导出至cassandra<span class="divider">/</span></li>
							<li>${defFileTask.fileId}</li>
						</ul>
					</div>
					
					<form name="defFileTaskDataForm" class="form-horizontal" method="post" id="defFileTaskDataForm" action="${ctx}/task/writeExportCassandraTask.do" onsubmit=""> 
						<input id="fileType" name="fileType" type="hidden" value="ExportCassandra" />
						...
						<div class="control-group">
							<label class="control-label">存至cassandra"库.表"</label>
							<div class="controls">

package com.meteor.datasync.plugin;
...
import com.meteor.util.FreemarkerUtil;

/**
 * Created by huangshaoqian on 2015/10/10.
 */
		...
		try {
			...
			while (rs.next()) {
				...
				for (int i = 0; i < columns.length; i++) {
					line.append(rs.getString(columns[i])).append(FIELD_SPLIT);
				}

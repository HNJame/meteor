package com.meteor.model.view.importqueue;
...
public class ImportKafkaTask extends AbstractTaskDepend {
	...
	public final String CLASS = "com.meteor.model.view.importqueue.ImportKafkaTask";
	...
	public ImportKafkaTask() {
		...
		this.setProgramClass("com.meteor.server.executor.ImportKafkaTaskExecutor");
	}

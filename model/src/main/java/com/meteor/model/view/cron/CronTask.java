package com.meteor.model.view.cron;
...
public class CronTask extends AbstractTaskDepend {
	...
	public final String CLASS = "com.meteor.model.view.cron.CronTask";
    
    private String cronExp;

    public CronTask() {
        this.setFileType(FileType.Cron.name());
        this.setProgramClass("com.meteor.server.executor.CronTaskExecutor");
    }

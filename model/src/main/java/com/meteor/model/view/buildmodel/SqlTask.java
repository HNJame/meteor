package com.meteor.model.view.buildmodel;
...
public class SqlTask extends AbstractTaskDepend {
	...
	public final String CLASS = "com.meteor.model.view.buildmodel.SqlTask";
    ...
    public SqlTask() {
        ...
        this.setProgramClass("com.meteor.server.executor.SqlTaskExecutor");
    }
